...
{
    BOOST_CHECK(true == std::is_same< std::tuple<std::size_t>,                            Index>::value);
    BOOST_CHECK(true == std::is_same< std::tuple<std::size_t, std::size_t>,               Indexes<2>>::value);
    BOOST_CHECK(true == std::is_same< std::tuple<std::size_t, std::size_t, std::size_t>,  Indexes<3>>::value);
    ...
    BOOST_CHECK(true == std::is_same< Concatenated2Indexes,                               Indexes<2> >::value );
    BOOST_CHECK(true == std::is_same< Concatenated3Indexes,                               Indexes<3> >::value );
    BOOST_CHECK(true == std::is_same< Concatenated4Indexes,                               Indexes<4> >::value );
